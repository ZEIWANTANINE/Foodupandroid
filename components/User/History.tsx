...
type ScreenANavigationProp = StackNavigationProp<RootStackParamList, 'History'>;
type Props = {
    ...
    return(
        <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.buttonContainer}>
                <TouchableOpacity >
                    <Text style={styles.buttonPush} onPress={() => navigation.navigate('StateGoing',{data:'default'})}>Đang Đến</Text>
                </TouchableOpacity>
                <TouchableOpacity>
                    <Text style={styles.buttonPush1} onPress={() => navigation.navigate('History',{data:'default'})}>Lịch Sử</Text>
                </TouchableOpacity>
                <TouchableOpacity>
                    <Text style={styles.buttonPush} onPress={() => navigation.navigate('Invoice',{data:'default'})}>Đánh Giá</Text>
                </TouchableOpacity>
                <TouchableOpacity>
                    <Text style={styles.buttonPush} onPress={() => navigation.navigate('Cancel',{data:'default'})}>Đã Huỷ</Text>
                </TouchableOpacity>
            </View>
            <View>
