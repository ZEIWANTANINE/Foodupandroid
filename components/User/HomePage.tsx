    ...
    <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.headerContainer}>
          <View style={styles.searchContainer}>
            ...
            <TouchableOpacity onPress={()=>navigation.navigate("Search",{data:data,text:textsearch})}><Icon name="search" style={styles.iconSearch}/></TouchableOpacity>
          </View>
  
          <TouchableOpacity onPress={goToCart}>
            <Icon name="shopping-basket"  style={styles.iconCart}/>
          </TouchableOpacity>
          <TouchableOpacity onPress={()=>navigation.navigate("Them",{data:'default'})}>
            <Icon name="shopping-basket"  style={styles.iconCart}/>
          </TouchableOpacity>
          <TouchableOpacity onPress={()=>navigation.navigate("Hien",{data:data})}>
            <Icon name="shopping-basket"  style={styles.iconCart}/>
          </TouchableOpacity>
        </View>
